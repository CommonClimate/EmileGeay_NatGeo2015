function [legend_h,object_h,plot_h,text_strings] = columnlegend_h(numcolumns, handles, str, varargin)
%
%   columnlegend creates a legend with a specified number of columns.
%   
%   columnlegend(numcolumns, handles, str, varargin)
%       numcolumns - number of columns in the legend
%       handles    - handles to graphical objects being labeled
...
%      end
%      columnlegend(3, legend_str, h, 'Location', 'NorthWest');
%
%
...
%   5/31/2013 - Added capacity to specify object handles to be labeled
...
%create the legend
[legend_h,object_h,plot_h,text_strings] = legend(handles, str);
